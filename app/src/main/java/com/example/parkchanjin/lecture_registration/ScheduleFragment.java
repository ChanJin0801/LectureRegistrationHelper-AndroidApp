...
public class ScheduleFragment extends Fragment {
    ...
    private AutoResizeTextView monday[] = new AutoResizeTextView[8];
    private AutoResizeTextView tuesday[] = new AutoResizeTextView[8];
    private AutoResizeTextView wednesday[] = new AutoResizeTextView[8];
    private AutoResizeTextView thursday[] = new AutoResizeTextView[8];
    private AutoResizeTextView friday[] = new AutoResizeTextView[8];
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute(){
            try{
                target = "http://10.0.2.2/ScheduleList.php?userID=" + URLEncoder.encode(MainActivity.userID, "UTF-8");
            }
            catch(Exception e){
                e.printStackTrace();
            }
